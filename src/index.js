export default {
  ...
  // Додаємо функцію для обробки Cron Trigger
  async scheduled(event, env) {
    console.log("Cron job triggered at:", new Date().toISOString());
    // Тут додай логіку для періодичних завдань, наприклад, видалення неактивних користувачів
    await removeInactiveUsers(env);
  },
};

// Функція для видалення неактивних користувачів (як у твоєму коді)
